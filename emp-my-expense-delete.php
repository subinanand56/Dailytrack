...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if (isset($_GET['review']) && $_GET['review'] == '1') {
        ...
        if (mysqli_query($conn, $sql)) {
            echo "<script type='text/javascript'>alert('Manager has reviewed the expense');window.location.href='emp-my-expense.php';</script>";
        } else {
        ...
        if ($result) {
            ...
            if ($review_status == '0') {
                ...
                if (mysqli_query($conn, $delete_sql)) {
                    echo "<script type='text/javascript'>alert('Successfully Deleted');window.location.href='emp-my-expense.php';</script>";
                } else {
                    echo "Error deleting record: " . mysqli_error($conn);
                }
            } else {
                echo "<script type='text/javascript'>alert('Manager reviewed');window.location.href='emp-my-expense.php';</script>";
            }
        } else {
