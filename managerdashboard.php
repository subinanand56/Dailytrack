...
if ($role !== 'Manager' || !isset($_SESSION['token'])) {
...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div id="sales-card" class="col-lg-3 col-sm-6">
            <a href="sales-table-form.php" style="text-decoration: none; color: inherit;">
          ...
          <div class="col-lg-3 col-sm-6">
            <a href="expense-table.php" style="text-decoration: none; color: inherit;">
          ...
          <div class="col-lg-3 col-sm-6">
            <a href="purchase-table.php" style="text-decoration: none; color: inherit;">
  ...
  <script>
    ...
    function setTodayDate() {
      ...
      updateDataForBranchAndDate('All', formattedDate, formattedDate);
      updateExpenseDataForBranchAndDate('All', formattedDate, formattedDate);
      updatePurchaseDataForBranchAndDate('All', formattedDate, formattedDate);
    }
    ...
    window.onload = function () {
      ...
      updateDataForBranchAndDate('All', formattedStartDate, formattedEndDate);
      updateExpenseDataForBranchAndDate('All', formattedStartDate, formattedEndDate);
      updatePurchaseDataForBranchAndDate('All', formattedStartDate, formattedEndDate);
