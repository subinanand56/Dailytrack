        ...
        <div class="row">
          <div class="card">
            <div class="card-header">
              <h4 class="card-title">Sale Entry Form</h4>
            </div>
            <div class="card-body">
              <div class="basic-form">
                <form action="empsale.php" method="post">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-6">
                      ...
                      $rs = $_SESSION["branch"];
                      ?>
                      <input type="text" class="form-control" name="branch" value='<?php echo $rs ?>' readonly>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Amount</label>
                      <input type="number" class="form-control" placeholder="amount" name="amount" step="any" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Product</label>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      ?>
                      <input type="date" class="form-control" name="date" value="<?php echo $currentDate; ?>" readonly
                        required>
                    </div>
                  </div>
                  <div class="form-row">
