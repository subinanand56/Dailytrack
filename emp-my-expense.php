...
if ($categoryFilter === 'All') {
    $query = "SELECT price, item, date, id, branch, text, review FROM expense WHERE branch='$id' ORDER BY date DESC";
} else {
    $query = "SELECT price, item, date, id, branch, text, review FROM expense WHERE branch='$id' AND item='$categoryFilter' ORDER BY date DESC";
}
    ...
    <div class="modal-overlay" id="modalOverlay">
        <div class="modal-content">
            <div id="updateForm" style="display: none;">
                <form action="emp-my-expense-update.php" method="POST">
                    ...
                    <input class="form-control" type="text" name="text" id="text" placeholder="Text" required>
                    <label style="color:black;">Date*</label>
                    <input class="form-control" type="text" name="date" id="date" placeholder="Date" readonly required>
                    <div style="align-item: center; margin-top: 1rem; ">
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($data = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="emp-my-expense-delete.php?id=<?php echo $data['id']; ?>"><button
    ...
    ***********************************-->
    ...
    <script>
        ...
        function filterTable(category) {
            ...
            window.location.href = 'emp-my-expense.php?category=' + category;
        }
    </script>
