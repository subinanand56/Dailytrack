...
<head>
    ...
    <style>
        ...
        .dataTables_wrapper option[value="10"],option[value="25"],option[value="50"]{
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" style="padding-top:30px;">
                                    ...
                                    $query = "SELECT  `name`, `email`, `branch`, `role`, `password`, `phone`, `address`,`id` FROM `register` ";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($data = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="empdelete.php?id=<?php echo $data['id']; ?>"><button
